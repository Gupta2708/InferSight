...
def upgrade() -> None:
    ...
    seed_rows = [
        ...
        ("00000000-0000-0000-0000-000000000104", "openai", "gpt-4.1-mini", True, True, 0.0004, 0.0016),
        ("00000000-0000-0000-0000-000000000105", "gemini", "gemini-2.5-flash", True, True, 0.0003, 0.0025),
    ]
